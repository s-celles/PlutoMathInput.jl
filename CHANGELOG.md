...
- `MathJSONDisplayExt`: pass `ce` (Compute Engine) to recursive `mjsonToLatex` calls, fixing display of nested `Add`/`Multiply` expressions

## [0.4.0] - 2026-04-07

### Added

- `icon_position` keyword argument for `MathInput`: controls the position of the MathLive menu and virtual keyboard icons (`:left` or `:right`, default `:right`)
